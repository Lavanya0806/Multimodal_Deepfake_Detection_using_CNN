...
output_folder = 'audio_output'  # set your output folder and make sure it exists
...
def plot_audio_spectrogram(audio_path, binsize=2**10, plot_path=None, argv = '', colormap="jet"):
    ...
    epsilon = 1e-10
    data = 20. * np.log10(np.abs(new_spectrogram) / 10e+6 + epsilon)  # dBFS
...
# Test the function with your audio files

folder_list = os.listdir('audio')


for folder in folder_list:
        
    # create a path to the folder
    path = './audio/' + str(folder)
    path1 = './audio_output/' + str(folder)
